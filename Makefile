...
all: vuln.s vuln driver driver_authd_expl driver_smash_data driver_return_to_libc driver_stack_code_injection driver_heap_code_injection driver_format_string
