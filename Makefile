...
all: vuln.s vuln driver driver_authd_expl driver_smash_data driver-heap
...
driver-heap: driver-heap.c
	gcc $(CFLAGS) -o driver-heap driver-heap.c
...
clean:
	rm -f vuln vuln.o my_malloc.o vuln.s padding.h driver_authd_expl driver driver_smash_data driver-heap
