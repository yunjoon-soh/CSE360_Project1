...
int main(int argc, char* argv[]) {
   ...
   void *auth_bp = 0xbfffe378;     // saved ebp for auth function
   void *mainloop_bp = 0xbfffea78; // saved ebp for main_loop
   ...
   void *auth_canary_loc = 0xbfffe36c; // location where auth's canary is stored
   void *auth_bp_loc = 0xbfffe378; // location of auth's saved bp
   void *auth_ra_loc = 0xbfffe37c; // location of auth's return address
